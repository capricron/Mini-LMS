    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LearnerSubmissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LearnerSubmissions_Assignments_AssignmentId",
                        column: x => x.AssignmentId,
                        principalTable: "Assignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LearnerSubmissions_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubmittedAnswers_LearnerSubmissions_SubmissionId",
                        column: x => x.SubmissionId,
                        principalTable: "LearnerSubmissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "user2", "andi@example.com", "$2a$11$abcXYZ123defABC789ghiOQwZtLmNpQzE6bOqFyKUfS0Zl9uT8wC", 2, "andi" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_LearnerSubmissions_AssignmentId",
                table: "LearnerSubmissions",
                column: "AssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_LearnerSubmissions_UserId",
                table: "LearnerSubmissions",
                column: "UserId");
